...
- **Background:** the process is elaborated chapter-by-chapter in Goodell & Kolodner (eds.), *Learning Engineering Toolkit* (Routledge, 2022). Three chapters are open access via Taylor & Francis; both are on the [Reading List](/reading-list/).
