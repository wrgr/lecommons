...
tags:
  ...
  - "standards"
  - "icicle"
summary: "Caliper is xAPI's closest sibling — a learning-analytics interop standard from 1EdTech. If you're picking an LMS analytics stack, you'll encounter both."
provenance:
